...
<main class="form-signin">
    <form action="#" method="post">
        ...
        <div class="form-floating">
            <input name="nome" type="text" class="form-control" id="floatingInput" placeholder="John herbert">
        ...
        <button name="registrar" class="w-100 btn btn-lg btn-primary" type="submit">Registrar</button>
